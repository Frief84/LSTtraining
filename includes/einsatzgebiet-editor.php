...
function lsttraining_einsatzgebiet_editor($mapId = 'polygon_map', $inputId = 'einsatzgebiet_geojson', $geojson = '') {
    ...
    echo '<button type="button" class="button" onclick="toggleEinsatzgebietEditor()">Einsatzgebiet bearbeiten</button>';
    echo '<div id="einsatzgebiet-editor-container" style="display:none; margin-top: 15px;">';
    ...
    echo "<script>
    function toggleEinsatzgebietEditor() {
        const container = document.getElementById('einsatzgebiet-editor-container');
