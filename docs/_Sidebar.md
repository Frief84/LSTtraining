...
- [Spielerhandbuch](spielerhandbuch.md)
- [Administration und Stammdaten](administration.md)
- [Simulation und Multiplayer](simulation-und-multiplayer.md)
- [Sicherheit und Migration](sicherheit-migration-multiplayer.md)
...
> `_Sidebar.md` ist zugleich als Vorlage verwendbar, falls die Dokumentation später in die separate GitHub-Wiki-Funktion übernommen wird.
